...
dvizh_ok.add_circle(ctypes.c_double(20), ctypes.c_double(1), ctypes.c_double(500 + randint(-200, 200)), ctypes.c_double(250 + randint(-100, 100)), ctypes.c_double(randint(-25, 25)), ctypes.c_double(randint(-25, 25)))
dvizh_ok.add_circle(ctypes.c_double(20), ctypes.c_double(1), ctypes.c_double(500 + randint(-200, 200)), ctypes.c_double(250 + randint(-100, 100)), ctypes.c_double(randint(-25, 25)), ctypes.c_double(randint(-25, 25)))
dvizh_ok.add_circle(ctypes.c_double(20), ctypes.c_double(1), ctypes.c_double(500 + randint(-200, 200)), ctypes.c_double(250 + randint(-100, 100)), ctypes.c_double(randint(-25, 25)), ctypes.c_double(randint(-25, 25)))
dvizh_ok.add_circle(ctypes.c_double(20), ctypes.c_double(1), ctypes.c_double(500 + randint(-200, 200)), ctypes.c_double(250 + randint(-100, 100)), ctypes.c_double(randint(-25, 25)), ctypes.c_double(randint(-25, 25)))
dvizh_ok.add_circle(ctypes.c_double(50), ctypes.c_double(1), ctypes.c_double(500 + randint(-200, 200)), ctypes.c_double(250 + randint(-100, 100)), ctypes.c_double(randint(-25, 25)), ctypes.c_double(randint(-25, 25)))
dvizh_ok.add_circle(ctypes.c_double(50), ctypes.c_double(1), ctypes.c_double(500 + randint(-200, 200)), ctypes.c_double(250 + randint(-100, 100)), ctypes.c_double(randint(-25, 25)), ctypes.c_double(randint(-25, 25)))
dvizh_ok.add_circle(ctypes.c_double(50), ctypes.c_double(1), ctypes.c_double(500 + randint(-200, 200)), ctypes.c_double(250 + randint(-100, 100)), ctypes.c_double(randint(-25, 25)), ctypes.c_double(randint(-25, 25)))
dvizh_ok.add_circle(ctypes.c_double(50), ctypes.c_double(1), ctypes.c_double(500 + randint(-200, 200)), ctypes.c_double(250 + randint(-100, 100)), ctypes.c_double(randint(-25, 25)), ctypes.c_double(randint(-25, 25)))

###dvizh_ok.add_circle(ctypes.c_double(30), ctypes.c_double(1), ctypes.c_double(100), ctypes.c_double(200), ctypes.c_double(+25), ctypes.c_double(0))
###dvizh_ok.add_circle(ctypes.c_double(30), ctypes.c_double(1), ctypes.c_double(200), ctypes.c_double(220), ctypes.c_double(-25), ctypes.c_double(0))
