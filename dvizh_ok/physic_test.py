...
for i in range(16):
    dvizh_ok.add_circle(ctypes.c_double(randint(10, 50)), ctypes.c_double(1), ctypes.c_double(500 + randint(-200, 200)), ctypes.c_double(250 + randint(-100, 100)), ctypes.c_double(randint(-25, 25)), ctypes.c_double(randint(-25, 25)))
